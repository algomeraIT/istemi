                       ...
                       draggedItem = null;
                        ...
                        <div class="flex justify-between border-b-2">
                            <p class="text-lg font-medium  text-left text-[#6C757D] text-[19px] mb-4">
                                ...
                                <!-- Sorting Button -->
                                <button wire:click="sortBy('n_file', '{{ $phaseId }}')"
                            ...
                            @if (isset($projects[$phaseId]) && is_array($projects[$phaseId]))
                                @foreach ($projects[$phaseId] ?? [] as $project)
                                    ...
                                    <div class="bg-white border font-inter border-gray-300 p-4 text-sm rounded shadow cursor-pointer hover:shadow-lg transition w-[360px] h-[231px] overflow-hidden flex flex-col justify-between"
                                        ...
                                        {{-- Project Info --}}
                                        <h3 class="text-lg font-semibold text-[#232323]">{{ $project['n_file'] }}</h3>
                                        ...
                                        <div class="flex gap-2 text-left">
                                            <flux:button wire:click="edit({{ $project['id'] }})" variant="ghost"
