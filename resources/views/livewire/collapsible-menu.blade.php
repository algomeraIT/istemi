    ...
    <template x-teleport=".megamenu">
        <div x-show="isMenuOpen" x-transition:enter="transition ease-out duration-300"
            ...
            <div x-data="{
                ...
                {{--          <div id="menu-content" class="container  mx-auto mt-[47px]"
                    x-bind:style="isExpanded ? 'justify-self: center; max-width:1000px' : ''">
                    <div class="grid grid-cols-1 grid-rows-8 divide-y *:px-2 lg:grid-cols-8 lg:grid-rows-1 lg:divide-x lg:divide-y-0"
                        x-bind:class="{ 'list-item list-none': isExpanded }">
                        ...
                        <div class="menu-item w-max-52 mr-5 "
                            ...
                            <a href="#" class="block group lg:ml-2.5 h-[32px]">
                                <div class="flex w-[200px] h-[17px]" x-show="!isExpanded">
                                    <img src="/icon/menu/progetti.svg" alt="Dashboard"
                                        class="mt-[4px] object-cover transition duration-300 group-hover:scale-105">
                                    <p
                                        class="font-thin text-[15px] text-[#C7C7C7] ml-[10px] w-[200px] h-[32px] font-inter">
                                        Dashboard
                                    </p>
                                </div>
                            </a>
                            ...
                            <template
                                ...
                                <div class="menu-item-inside grid   "
                                    ...
                                    <a :href="item.route"
                                        ...
                                        :class="{
                                            'pl-4': !isExpanded,
                                            'text-[#10BDD4]': new URL(item.route, window.location.origin)
                                                .pathname === window.location.pathname,
                                            'text-[#B0B0B0] group-hover:text-[#10BDD4]': new URL(item.route, window
                                                .location.origin).pathname !== window.location.pathname
                                        }">
                                        <span x-text="item.label"></span>
                                        <span
                                            class="absolute left-0 bottom-0 w-0 h-[1px] bg-gray-400 transition-all duration-200 group-hover:w-full"></span>
                        ...
                        <div class="menu-item w-max-52 mr-5"
                            ...
                            <template
                                x-for="item in [
                                    { label: 'Progetti', icon: '/icon/menu_exploded/progetti.svg', route: '{{ route('projects.project') }}' },
                                    { label: 'Pianificazione', icon: '/icon/menu_exploded/pianificazione.svg', route: '#' },
                                    { label: 'Mappa', icon: '/icon/menu_exploded/mappa.svg', route: '#' },
                                    { label: 'Progetti Archiviati', icon: '/icon/menu_exploded/progetti archiviati.svg', route: '#' }
                                ]"
                                :key="item.label">
                        ...
                        <div class="menu-item w-max-52 mr-5"
                            ...
                            <a href="#" class="block group lg:ml-2.5 h-[32px]">
                                <div class="flex w-[200px] h-[17px]" x-show="!isExpanded">
                                    <img src="/icon/menu/progetti.svg" alt="Operazioni & risorse"
                                        class="mt-[4px] object-cover transition duration-300 group-hover:scale-105">
                                    <p
                                        class="font-thin text-[15px] text-[#C7C7C7] ml-[10px] w-[200px] h-[32px] font-inter">
                                        Operazioni & risorse
                        ...
                        <div class="menu-item w-max-52 mr-5"
                            ...
                            <a href="#" class="block group lg:ml-2.5 h-[32px]">
                                <div class="flex w-[200px] h-[17px]" x-show="!isExpanded">
                                    <img src="/icon/menu/progetti.svg" alt="Dipendenti"
                                        class="mt-[4px] object-cover transition duration-300 group-hover:scale-105">
                                    <p
                                        class="font-thin text-[15px] text-[#C7C7C7] ml-[10px] w-[200px] h-[32px] font-inter">
                                        Dipendenti
                        ...
                        <div class="menu-item w-max-52 mr-5"
                            ...
                            <a href="#" class="block group lg:ml-2.5 h-[32px]">
                                <div class="flex w-[200px] h-[17px]" x-show="!isExpanded">
                                    <img src="/icon/menu/progetti.svg" alt="Amministrazione"
                                        class="mt-[4px] object-cover transition duration-300 group-hover:scale-105">
                                    <p
                                        class="font-thin text-[15px] text-[#C7C7C7] ml-[10px] w-[200px] h-[32px] font-inter">
                                        Amministrazione
                        ...
                        <!-- Menu Item - Documenti -->
                        <div class="menu-item w-max-52 mr-5"
                            :class="isExpanded ? '' : 'h-88 border-l-2 border-gray-200'"
                            x-bind:style="isExpanded ? 'height: 0px;' : ''">
                            ...
                            <a href="#" class="block group lg:ml-2.5 h-[32px]">
                                <div class="flex w-[200px] h-[17px]" x-bind:hidden="isExpanded">
                                    <img src="/icon/menu/documenti.svg" alt="Documenti"
                                        class="mt-[4px] object-cover transition duration-300 group-hover:scale-105">
                                    <p
                                        class="font-light text-[15px] leading-[19px] tracking-[0px] text-[#C7C7C7] opacity-100 text-left font-inter w-[200px]  ml-[10px] ">
                                        Documenti
                                    </p>
                                </div>
                            </a>
