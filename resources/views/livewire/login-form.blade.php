    ...
    <form wire:submit="{{ $showForgotPassword ? 'sendResetLink' : 'submit' }}"
        ...
        <div class="ml-[50px] mt-[52px]">
            ...
            <label for="email" class=" font-light text-lg leading-[21px] text-[#A0A0A0] opacity-100">
                ...
                <p class="flex float-right mr-[50px] italic font-light text-[16px] leading-[20px] tracking-[0px] text-[#28A745] opacity-100"><flux:icon.check-circle /> {{ $messageEmailValid }}</p>
                @endif
            </label>
            ...
            <div class="relative">
                ...
                <input type="{{ $showPassword ? 'text' : 'password' }}" wire:model="password" wire:model.live="password"
            ...
            <div class="mb-[24px]  mt-[48px] ">
                <button type="submit" wire:loading.attr="disabled" class="w-[200px] h-[50px]  transition-colors duration-300 ease-in-out {{ 
            ...
            <div class="ml-[50px] mt-[52px]">
                ...
                <div class="relative mb-12">
                    ...
                    <input type="email" id="email" name="email" wire:model="email" wire:model.live="forgotPasswordEmail"
                        class="mt-[12px] w-[433px] h-[40px] border text-sm  ps-12 p-2.5 placeholder:italic placeholder:font-thin placeholder:text-[16px] placeholder:leading-[20px] placeholder:ml-[20px] placeholder:text-[#BEBBBB] placeholder:tracking-[0px] placeholder:opacity-80 autofill:shadow-[inset_0_0_0px_1000px_white] focus:bg-white"
                        placeholder="esempio@istemi.com">
                </div>
                ...
                <div class="mt-4 flex space-x-2">
                 {{--    <button type="button" wire:click="toggleForgotPassword"
                        class="w-[242px] h-50px bg-white text-gray-500 cursor-pointer">
                        Annulla
                    </button> --}}

                    <button type="submit" class="w-[242px] h-[50px] {{ 
                                !$this->forgotPasswordEmail
                ? ' text-[#10BDD44D] font-semibold text-[21px] leading-[24px] tracking-[0px] opacity-100  cursor-not-allowed'
            : ' text-white  bg-[#10BDD4] font-semibold text-[21px] leading-[24px] tracking-[0px] opacity-100 cursor-pointer' 
