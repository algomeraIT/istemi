            ...
            <div class="p-6">
                @if ($selectedNote)
                    <p><strong>Nome e Cognome:</strong>
                        {{ $selectedNote->name_user . ' ' . $selectedNote->last_name_user }}
                    </p>
                                ...
                                @else
                                    <label for="logo"
                                        ...
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                            ...
                                            <p class="mb-2 text-sm text-gray-500"><span class="font-semibold">Clicca
                                                    per
                            ...
                            <div x-data="{
                                ...
                                <div class="relative">
                                    ...
                                    <div x-show="query.length > 0" x-transition
                                        ...
                                        <ul>
                                            <template x-for="(email, index) in filteredEmails()"
                                                :key="index">
