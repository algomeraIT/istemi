    ...
    <div class="bg-white w-1/3 h-full shadow-lg transform transition-transform duration-300 ease-in-out"
        ...
        <div class="p-6 ml-16 mr-16">
            ...
            <div>
                ...
                <div class="border-l">
                    <div class=" ml-8 ">
                        <p class="font-extralight flex"><flux:icon.wrench class="" />Attività</p>
                    ...
                    <div class="flex ml-5">
                        <div class="m-4 ">
                            <p class="font-extralight flex mb-1.5"><flux:icon.at-symbol class="" />Assegnato a</p>
                            <img class=" w-5 h-5"
                                src="{{ $selectedActivity->user->image_path? asset($selectedActivity->user->image_path) : asset('icon/navbar/user.svg') }}"
                                class="rounded-full h-10 w-10 object-cover" />
                        </div>
                        <div class="m-4 ">
                            <p class="font-extralight flex mb-1.5"><flux:icon.at-symbol class="" />Conoscenza</p>
                            <img class="w-5 h-5"
                        ...
                        <div class="m-4 ">
                            <p class="font-extralight flex mb-1.5"><flux:icon.calendar-days class="" />Scadenza</p>
                            <p class="text-[#28A745]">
