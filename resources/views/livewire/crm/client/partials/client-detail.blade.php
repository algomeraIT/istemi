    ...
    <div class="order-first xl:order-last w-full xl:max-w-[419px] mt-6 lg:mt-0">
        <div class="border border-dashed border-[#10BDD4] rounded-sm">
            ...
            <div class="border-b border-dashed border-[#10BDD4] bg-[#F5FCFD] h-18 relative">
                <div
                    class="flex items-center justify-center w-24 h-24 overflow-hidden p-2 rounded-full border border-dashed border-[#10BDD4] bg-white absolute right-10 -bottom-12">
